-- STEP 1 of 2 â€” run this FIRST, then run STEP 2.
...
-- STEP 2 of 2 â€” run this AFTER STEP 1 has completed successfully.
...
-- Public lead intake.
--
-- The contact form (and admission-desk) are public pages â€” anonymous
...
-- it commit before running 20260620000000_full_crm_buildout.sql â€” Postgres
...
-- and committed (separate paste) â€” this file uses the 'super_admin' enum
...
-- =========================================================================
-- 4. Documents (Aadhaar / Photo / Marksheets) â€” metadata row per upload
-- =========================================================================
...
-- =========================================================================
-- 6. Universities & Boards â€” move off the static catalog into the DB
-- =========================================================================
...
INSERT INTO public.boards (id, name, level, body, description, eligibility, subjects, highlight) VALUES
  ('sbse-10', 'Sikkim Board (SBSE) â€” Secondary', '10th', 'Sikkim Board of Secondary Education Â· Gangtok', 'The SBSE Secondary certificate is a government-recognized Class 10 qualification, designed for learners who left school early and now need a valid matriculation credential to move forward.', 'Previous grade marks card Â· No upper age limit', ARRAY['English','Mathematics','Science','Social Science','Regional Language'], 'Simplified examination pattern with flexible study schedules.'),
  ('sbse-12', 'Sikkim Board (SBSE) â€” Senior Secondary', '12th', 'Sikkim Board of Secondary Education Â· Gangtok', 'The SBSE Senior Secondary certificate is a recognized Class 12 qualification that opens the door to undergraduate study, including the online degree programs listed in our university directory.', 'Class 10 marks card from any recognized board', ARRAY['English','Accountancy','Business Studies','Economics','Political Science'], 'Direct pathway into UGC-DEB approved online degrees.'),
  ('nios-10', 'NIOS â€” Secondary', '10th', 'National Institute of Open Schooling Â· NOIDA', 'NIOS is the world''s largest open schooling system, run by the Government of India. Its Secondary course offers Class 10 certification with on-demand examinations and full subject flexibility.', 'Age 14+ Â· Self-certification of Class 8 level study', ARRAY['English','Mathematics','Science & Technology','Social Science','Data Entry Operations'], 'On-demand exams â€” appear when you are ready.'),
  ('nios-12', 'NIOS â€” Senior Secondary', '12th', 'National Institute of Open Schooling Â· NOIDA', 'The NIOS Senior Secondary course is a Class 12 qualification accepted by universities and government bodies across India, with the freedom to choose your own subject combination.', 'Class 10 pass from any recognized board', ARRAY['English','Accountancy','Business Studies','Economics','Psychology'], 'Choose any subject combination â€” commerce, arts or science.')
ON CONFLICT (id) DO NOTHING;

-- =========================================================================
-- 7. Counters â€” atomic sequence generator for ADM-YYYY-#### / ENR-... numbers
-- =========================================================================
...
-- -------------------------------------------------------------------------
-- 1. Notes â€” unlimited notes per student; never deleted, edits tracked.
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- 2. Timeline â€” permanent, append-only event log per student.
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- 3. Activity logs â€” every important action, with before/after values.
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- 4. UTR uniqueness â€” duplicate UTR is not allowed (ignores NULLs).
-- -------------------------------------------------------------------------
